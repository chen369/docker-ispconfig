...
RUN apt-get -y install postfix postfix-mysql postfix-doc mariadb-server libdbi-perl libdbd-mysql-perl libterm-readkey-perl mariadb-client-10.0 mariadb-server-10.0 mariadb-client mariadb-server getmail4 rkhunter binutils dovecot-imapd dovecot-pop3d dovecot-mysql dovecot-sieve dovecot-lmtpd sudo
...
RUN service mysql restart && apt-get -y install apache2 apache2.2-common apache2-doc apache2-mpm-prefork apache2-utils libexpat1 ssl-cert libapache2-mod-php7.0 php7.0 php7.0-common php7.0-gd php7.0-mysql php7.0-imap phpmyadmin php7.0-cli php7.0-cgi libapache2-mod-fcgid apache2-suexec php-pear php-auth php7.0-mcrypt mcrypt php7.0-imagick imagemagick libruby libapache2-mod-python php5-curl php5-intl php5-memcache php5-memcached php7.0-pspell php7.0-recode php5-sqlite php7.0-tidy php7.0-xmlrpc php7.0-xsl memcached libapache2-mod-passenger
